...
public class RegisterTest {
    ...
    public class GerenciamentoCLiente{
        ...
        public void deveCadastrarCliente() throws Exception {
            ...
            doNothing().when(registerCustomerController).invoke(inputDataCustomerDTO.cpf(), inputDataCustomerDTO.name(), inputDataCustomerDTO.email());
            ...
            // THEN
            verify(registerCustomerController, times(1)).invoke(inputDataCustomerDTO.cpf(), inputDataCustomerDTO.name(), inputDataCustomerDTO.email());
